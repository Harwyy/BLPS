...
#### Предусловия
 ...
 - Заказ находится в статусе READY (приготовлен рестораном).
 - Существует хотя бы один курьер в том же городе со статусом AVAILABLE и количеством активных заказов < 2.
